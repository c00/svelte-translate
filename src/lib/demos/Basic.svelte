...
<div class="container mx-auto">
	...
	<h4 class="mb-4"><a class="text-slate-500 hover:underline hover:text-slate-700" href="https://github.com/c00/svelte-translate/tree/main/src/lib/demos/Basic.svelte">code on github</a></h4>
	<Translate {opts} {data}>
		<LanguageButtons />
