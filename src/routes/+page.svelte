...
<div class="container mx-auto pb-24">
	<div class="flex items-center">
		<h1 class=" mt-4 mb-2 font-bold text-2xl grow">Svelte Translate</h1>

		<a
			href="https://github.com/c00/svelte-translate"
			class="text-slate-500 hover:text-slate-700 transition-all mt-2"
		>
			GitHub
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 inline-block">
				<path
					fill="currentColor"
